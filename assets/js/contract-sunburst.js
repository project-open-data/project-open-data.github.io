...
d3.select("#legend_scaleKey").append("circle")
 ...
 var width = 700,
  ...
  var svg = d3.select("#sunburst").append("svg")
    ...
    .attr("height", height)
    .append("g")
    .attr("transform", "translate(" + (width / 2-135) + "," + (height / 2-20) + ")");
