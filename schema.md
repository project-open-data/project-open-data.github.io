...
**Usage Notes** | Distribution is a concatenation, as appropriate, of the following elements: **accessURL** and **format**.  If an entry has only one dataset, enter details for that one; if it has multiple datasets (such as a bulk download and an API), separate entries as seen below:  
    ...
    "distribution": [
            {
                "accessURL":"https://catalog.data.gov/views/ykv5-fn9t/rows.csv?accessType=DOWNLOAD", 
                "format":"text/csv"
            }, 
            {
                "accessURL":"https://catalog.data.gov/views/ykv5-fn9t/rows.json?accessType=DOWNLOAD", 
                "format":"application/json"
            }, 
            {
                "accessURL":"https://catalog.data.gov/views/ykv5-fn9t/rows.xml?accessType=DOWNLOAD", 
                "format":"text/xml"
            }
        ]
