...
# Elements: Awardee/Recipient Unique Identifier and Legal Business Name
...
<table>
  ...
  <tr>
    <td>Awardee/Recipient Legal Business Name</td>
    <td>Awardee and Recipient Entity Information</td>
    <td>FFATA</td>
  </tr>
  <tr>
  ...
  <tr>
    <td>Ultimate Parent Legal Business Name</td>
    <td>Awardee and Recipient Entity Information</td>
    <td>FFATA</td>
  </tr>
</table>
...
Over the past 20 years, however, data and information technology capabilities have changed and circumstances in the Federal award community have evolved.  Congress has enacted legislation that requires expanded identification of entities working with the Federal government and the development of policies to better trace Federal dollars from appropriation to final outcomes or results.  While key information needed to verify legal businesses may reside in a few providers, options for uniquely identifying those working with the Federal government have expanded.   As a result, the Federal government is changing the FAR and 2 CFR to remove the proprietary references of DUNS&#174; and instead refer to a “unique entity identifier”.
...
* _Awardee/Recipient Legal Business Name_:  The name of the awardee/recipient that relates to the Awardee DUNS&#174; Number.  For U.S. based companies, this name is what the business ordinarily files in its formation documents with the individual states (when this is required).
...
* _Ultimate Parent Legal Business Name_:  Awardee/Recipient Parent Legal Business Name – The name of the ultimate parent of the awardee/recipient that relates to the Awardee/Recipient Parent DUNS&#174; Number.
...
Note that legal business name, parent DUNS&#174; number, and parent legal business name are not specifically defined in the FAR or 2 CFR, but are necessary to comply with FFATA.  Legal business name is used to distinguish from the use of various ‘tradestyle’ or ‘doing business as’ names.

Going forward, the Federal government will explore potential alternatives to meet the requirement for a unique identifier currently met by use of the DUNS&#174; number.  Any changes to the use of the DUNS&#174; number for these processes will require resources to change agencies’ financial, grants, and procurement systems as well as systems supporting government-wide systems used for analysis or display of data.  This will be a significant and lengthy effort to review and implement any suggested changes.
