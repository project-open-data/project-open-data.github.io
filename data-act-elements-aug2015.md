					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">RecipientLegalEntityAddressStreet2<a id="#C14"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">RecipientLegalEntitylCityName<a id="#C15"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">RecipientLegalEntitylCityName<a id="#C16"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">RecipientLegalEntityStateCode<a id="#C17"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">RecipientLegalEntityStateCode<a id="#C18"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">RecipientLegalEntityZip<a id="#C19"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">RecipientLegalEntityZip<a id="#C20"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">RecipientLegalEntityZip+4<a id="#C21"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">RecipientLegalEntityZip+4<a id="#C22"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">RecipientLegalEntityPostalCode<a id="#C23"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">RecipientLegalEntityPostalCode<a id="#C24"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">RecipientLegalEntityCongresionalDistrict<a id="#C25"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">RecipientLegalEntityCongresionalDistrict<a id="#C26"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">RecipientLegalEntityCountryCode<a id="#C27"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">RecipientLegalEntityCountryCode<a id="#C28"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">RecipientLegalEntityCountryName<a id="#C29"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">RecipientLegalEntityCountryName<a id="#C30"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">HighCompOfficer1FirstName<a id="#C31"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">HighCompOfficer1FirstName<a id="#C32"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">HighCompOfficer1MiddleInitial<a id="#C33"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">HighCompOfficer1MiddleInitial<a id="#C34"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">HighCompOfficer1LastName<a id="#C35"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">HighCompOfficer1LastName<a id="#C36"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">HighCompOfficer2FirstName<a id="#C37"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">HighCompOfficer2FirstName<a id="#C38"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">HighCompOfficer2MiddleInitial<a id="#C39"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">HighCompOfficer2MiddleInitial<a id="#C40"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">HighCompOfficer2LastName<a id="#C41"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">HighCompOfficer2LastName<a id="#C42"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">HighCompOfficer3FirstName<a id="#C43"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">HighCompOfficer3FirstName<a id="#C44"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">HighCompOfficer3MiddleInitial<a id="#C45"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">HighCompOfficer3MiddleInitial<a id="#C46"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">HighCompOfficer3LastName<a id="#C47"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">HighCompOfficer3LastName<a id="#C48"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">HighCompOfficer4FirstName<a id="#C49"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">HighCompOfficer4FirstName<a id="#C50"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">HighCompOfficer4MiddleInitial<a id="#C51"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">HighCompOfficer4MiddleInitial<a id="#C52"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">HighCompOfficer4LastName<a id="#C53"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">HighCompOfficer4LastName<a id="#C54"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">HighCompOfficer5FirstName<a id="#C55"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">HighCompOfficer5FirstName<a id="#C56"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">HighCompOfficer5MiddleInitial<a id="#C57"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">HighCompOfficer5MiddleInitial<a id="#C58"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">HighCompOfficer5LastName<a id="#C59"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">HighCompOfficer5LastName<a id="#C60"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">HighCompOfficer1Amount<a id="#C61"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">HighCompOfficer1Amount<a id="#C62"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">HighCompOfficer2Amount<a id="#C63"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">HighCompOfficer2Amount<a id="#C64"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">HighCompOfficer3Amount<a id="#C65"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">HighCompOfficer3Amount<a id="#C66"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">HighCompOfficer4Amount<a id="#C67"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">HighCompOfficer4Amount<a id="#C68"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">HighCompOfficer5Amount<a id="#C69"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">HighCompOfficer5Amount<a id="#C70"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">FederalActionObligation<a id="#C71"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">AmountofAward<a id="#C72"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">OrginalSubsidyCost<a id="#C73"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">NonFederalFundingAmount<a id="#C74"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">TotalFundingAmount<a id="#C75"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">TotalFundingAmount<a id="#C76"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">CurrentTotalValueAwardAmount<a id="#C77"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">FaceValueLoanGuarantee<a id="#C78"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">PotentialTotalValueAwardAmount<a id="#C79"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">TypeOfContractPricing<a id="#C80"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">TypeOfContractPricing<a id="#C81"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">idvType<a id="#C82"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">ContractAwardType<a id="#C83"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">AssistanceType<a id="#C84"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">FederalPrimeAward<a id="#C85"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">NAICS_Code<a id="#C86"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">NAICS_Code<a id="#C87"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">NAICS_Description<a id="#C88"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">NAICS_Description<a id="#C89"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">CFDA_Code<a id="#C90"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">CFDA_Code<a id="#C91"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">CFDA_Description<a id="#C92"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">CFDA_Description<a id="#C93"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">AllocationTransferAgencyIdentifier<a id="#C94"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">AllocationTransferAgencyIdentifier<a id="#C95"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">AllocationTransferAgencyIdentifier<a id="#C96"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">AgencyIdentifier<a id="#C97"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">AgencyIdentifier<a id="#C98"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">AgencyIdentifier<a id="#C99"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">BeginningPeriodOfAvailability<a id="#C100"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">BeginningPeriodOfAvailability<a id="#C101"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">BeginningPeriodOfAvailability<a id="#C102"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">EndingPeriodOfAvailability<a id="#C103"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">EndingPeriodOfAvailability<a id="#C104"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">EndingPeriodOfAvailability<a id="#C105"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">AvailabilityTypeCode<a id="#C106"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">AvailabilityTypeCode<a id="#C107"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">AvailabilityTypeCode<a id="#C108"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">MainAccountCode<a id="#C109"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">MainAccountCode<a id="#C110"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">MainAccountCode<a id="#C111"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">AwardDescription<a id="#C112"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">AwardDescription<a id="#C113"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">AwardModAmendmentNumber<a id="#C114"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
								...
								<tr>
									...
									<td>Procurement: A modification / amendment number of zero (??
?0”) indicates the initial award. </td>
								</tr>
							</tbody>
						</table>
					</div>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">AwardModAmendmentNumber<a id="#C115"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">ParentAwardIDprefix<a id="#C116"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">ParentAwardYear<a id="#C117"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">ParentAwardType<a id="#C118"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">ParentAwardNumber<a id="#C119"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">ActionDateDay<a id="#C120"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">ActionDateDay<a id="#C121"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">ActionDateMonth<a id="#C122"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">ActionDateMonth<a id="#C123"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">ActionDateYear<a id="#C124"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">ActionDateYear<a id="#C125"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">PeriodOfPerfStartDay<a id="#C126"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">PeriodOfPerfStartMonth<a id="#C127"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">PeriodOfPerfStartYear<a id="#C128"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">PeriodOfPerfCurrentEndDay<a id="#C129"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">PerioOfPerfCurrentEndMonth<a id="#C130"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">PeriodOfPerfCurrentEndYear<a id="#C131"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">PeriodOfPerfPotentialEndDay<a id="#C132"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">PeriodOfPerfPotentialEndMonth<a id="#C133"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">PeriodOfPerfPotentialEndYear<a id="#C134"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">OrderingPeriodEndDay<a id="#C135"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">OrderingPeriodEndMonth<a id="#C136"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">OrderingPeriodEndYear<a id="#C137"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">PlaceOfPerfStreetLine1<a id="#C138"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">PlaceOfPerfStreetLine1<a id="#C139"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">PlaceOfPerfState<a id="#C140"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">PlaceOfPerfCounty<a id="#C142"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">PlaceOfPerfCounty<a id="#C143"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">PlaceOfPerfPostalCode<a id="#C144"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">PlaceOfPerfPostalCode<a id="#C145"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">PlaceOfPerfCongressionalDistrict<a id="#C146"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">PlaceOfPerfCongressionalDistrict<a id="#C147"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">PlaceOfPerfCountryCode<a id="#C148"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">PlaceOfPerfCountryCode<a id="#C149"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">PlaceOfPerfCountryName<a id="#C150"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">PlaceOfPerfCountryName<a id="#C151"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">piidPrefix<a id="#C152"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">piidPrefix<a id="#C153"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">piidPrefix<a id="#C154"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">piidAwardYear<a id="#C155"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">piidAwardYear<a id="#C156"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">piidAwardYear<a id="#C157"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">piidAwardType<a id="#C158"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">piidAwardType<a id="#C159"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">piidAwardType<a id="#C160"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">piidAwardNumber<a id="#C161"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">piidAwardNumber<a id="#C162"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">piidAwardNumber<a id="#C163"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">fainAwardNumber<a id="#C164"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">fainAwardNumber<a id="#C165"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">fainAwardNumber<a id="#C166"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">RecordType<a id="#C167"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
								...
								<tr>
									...
									<td>Code indicating whether an actin is an individual transactin or aggregated.</td>
								</tr>
								<tr>
									<td>
										<strong>Example(s)</strong>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">TypeOfAction<a id="#C168"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
								...
								<tr>
									...
									<td>dentifies the type of change to the award as follows:
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">ReasonForModification<a id="#C169"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">BusinessTypes<a id="#C170"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">BusinessTypes<a id="#C171"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">FundingAgencyName<a id="#C172"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">FundingAgencyCode<a id="#C173"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">FundingSubTierAgencyName<a id="#C174"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">FundingSubTierAgencyCode<a id="#C175"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">FundingOfficeName<a id="#C176"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">FundingOfficeCode<a id="#C177"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">AwardingAgencyName<a id="#C178"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">AwardingAgencyName<a id="#C179"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">AwardingAgencyCode <a id="#C180"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">AwardingAgencyCode <a id="#C181"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">AwardingSubTierAgencyName<a id="#C182"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">AwardingSubTierAgencyCode<a id="#C183"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">AwardingOfficeName<a id="#C184"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">AwardingOfficeCode<a id="#C185"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">ObjectClass<a id="#C186"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
...
Ex2: 25.4</td>
								...
								<tr>
									...
									<td>Must be valid 3-digit object class as defined in OMB Circular A-11 Section 83.6.</td>
								</tr>
							</tbody>
						</table>
					</div>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">ObjectClass<a id="#C187"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">(represented by 21(A-F))<a id="#C188"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">(represented by 21(A-F))<a id="#C189"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">(represented by 21(A-F))<a id="#C190"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">BudgetAuthorityAppropriatedAmount<a id="#C191"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
...
(Broken out by each unique combination of TAS, object class, and program activity)<a id="#C192"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
...
(Broken out by each unique combination of TAS, object class, program activity, award, and award modification / amendment.)<a id="#C193"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">UnobligatedBalance<a id="#C194"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">OtherBudgetaryResourcesAmount<a id="#C195"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">ProgramActivity<a id="#C196"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
								...
								<tr>
									...
									<td>A specific activity or project as listed in the program and financing schedules of the annual budget of the United States Government.
(defined in OMB Circular A-11)</td>
								</tr>
								<tr>
									<td>
									...
									<td>Ex1: 0002 School improvement grants</td>
								</tr>
								<tr>
									<td>
										<strong>Data Type</strong>
								...
								<tr>
									...
									<td>Must be a valid project for the corresponding TAS/TAFS as listed in the program and financing schedules of the annual budget of the United States Government.</td>
								</tr>
							</tbody>
						</table>
					</div>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">OutlayAmount<a id="#C197"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">A76Action<a id="#C198"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">AmericanIndianOwned<a id="#C199"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">AsianPacOwned<a id="#C200"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">BlackOwned<a id="#C201"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">DodClaimantProgCode<a id="#C202"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">ClingerCohenCompliance<a id="#C203"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">CommercialItemAcquisProcedures<a id="#C204"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">CommercialItemTestProg<a id="#C205"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">SamException<a id="#C206"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">CompetativeProcedures<a id="#C207"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">ConsolidatedContract<a id="#C208"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">ContigencyHumanitarianPeacekeeping<a id="#C209"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">ContractBundling<a id="#C210"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">ContractFinancing<a id="#C211"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">CoDeterminationBusSize<a id="#C212"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">CostAcctStandardsClause<a id="#C213"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">CostOrPricingData<a id="#C214"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">CountryOfOrigin<a id="#C215"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">DavisBaconAct<a id="#C216"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">DivisionName<a id="#C217"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">DivisionNumber<a id="#C218"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">EducationalInstitution<a id="#C219"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">EmergingSmallBusiness<a id="#C220"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">EvaluatedPreference<a id="#C221"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">ExtentCompeted<a id="#C222"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">VendorFaxNumber<a id="#C223"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">FedBizOpps<a id="#C224"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">FederalGovernemntOrg<a id="#C225"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">8aProgramParticipant<a id="#C226"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">ForeignFunding<a id="#C227"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">GfeGfp<a id="#C228"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">HispanicOwned<a id="#C229"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">HistoricallyBlackCollegeOrUniversity<a id
="#C230"> </a></th>
								</tr>
							</thead>
							<tbody>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">Hospital<a id="#C231"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">HubZoneFirm<a id="#C232"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">IdvAgencyId<a id="#C233"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">InfoTechCommercialItemCategory<a id="#C234"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">InteragencyContractAuth<a id="#C235"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">LandGrantCollege1862<a id="#C236"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">LandGrantCollege1890<a id="#C237"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">LandGrantCollege1994<a id="#C238"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">AirportAuthority<a id="#C239"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">AlaskanNativeOwned<a id="#C240"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">ArchitectureAndEngineering<a id="#C241"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">CityLocalGovernment<a id="#C242"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">CommunityDevCorpOwned<a id="#C243"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">CommunityDevCorp<a id="#C244"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">ConstructionFirm<a id="#C245"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">CorporateEntityNotTaxExempt<a id="#C246"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">CorporateEntityTaxExampt<a id="#C247"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">CouncilOfGovernments<a id="#C248"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">CountyLocalGovernment<a id="#C249"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">DomesticShelter<a id="#C250"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">DotCertifiedDisadvantagedBusEnterprise<a id="#C251"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">WomanOwnedSmallBusiness<a id="#C252"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">FederalGovernmentAgency<a id="#C253"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">FederallyFundedResearchAndDevCorp<a id="#C254"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">ForeignGovernment<a id="#C255"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">ForeignOwnedAndLocated<a id="#C256"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">ForProfitOrg<a id="#C257"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">Foundation<a id="#C258"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">HispanicServicingInstitution<a id="#C259"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">HousingAuthorities<a id="#C260"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">IndianTribe<a id="#C261"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">InterMunicipalLocalGovernment<a id="#C262"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">InternationalOrg<a id="#C263"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">InterstateEntity<a id="#C264"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">JointVentureWomanOwnedSmallBusiness<a id
="#C265"> </a></th>
								</tr>
							</thead>
							<tbody>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">LaborSuplusAreaFirm<a id="#C266"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">LimitedLiabilityCorporation<a id="#C267"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">LocalGovernmentOwned<a id="#C268"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">ManufacturerOfGoods<a id="#C269"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">MunicipalityLocalGovernemnt<a id="#C270"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">NativeHawaiinOwned<a id="#C271"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">OtherBusOrOrg<a id="#C272"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">OtherMinorityOwned<a id="#C273"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">OtherNotForProfitOrg<a id="#C274"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">PartnershipOrLimitedLiabilityCorp<a id="#C275"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">PlanningCommision<a id="#C276"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">PortAuthority<a id="#C277"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">PrivateUniversityOrCollege<a id="#C278"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">SmallDisadvantaged<a id="#C279"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">SchoolDistrictLocalGovernment<a id="#C280"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">SchoolOfForestry<a id="#C281"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">ServiceProvider<a id="#C282"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">SmallAgriculturalCooperative<a id="#C283"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">SoleProprietorship<a id="#C284"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">StateInstitutionOfHigherLearning<a id="#C285"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">SubchapterSCorporation<a id="#C286"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">TownshipLocalGovernment<a id="#C287"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">TransitAuthority<a id="#C288"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">TribalCollege<a id="#C289"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">TriballyOwned<a id="#C290"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">VeterinaryCollege<a id="#C291"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">VeterinaryHospital<a id="#C292"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">UndefinitizedAction<a id="#C293"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">LocalAreaSetAside<a id="#C294"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">LocalGovernment<a id="#C295"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">MajorProgram<a id="#C296"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">PurchaseCardPayMethod<a id="#C297"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">MinorityInstitution<a id="#C298"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">MinorityOwned<a id="#C299"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">MultpleOrSingleAwardIdv<a id="#C300"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">MultiYearContract<a id="#C301"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">NativeOwned<a id="#C302"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">NationalInterestAction<a id="#C303"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">NonProfitOrganization<a id="#C304"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">NumberOfActions<a id="#C305"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">AnnualRevenue<a id="#C306"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">NumberOfEmployees<a id="#C307"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">NumberOfOffersReceived<a id="#C308"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">OtherStatutoryAuthority<a id="#C309"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">PerformanceBasedServiceAcquisition<a id="#C310"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">VendorPhoneNumber<a id="#C311"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">PlaceOfManufacture<a id="#C312"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">PriceEvaluationAdjPrefPctDiff<a id="#C313"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">ProductOrServiceCode<a id="#C314"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">ProgramAcronym<a id="#C315"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">ProductOrServiceDescription<a id="#C316"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">ReasonForNotCompleted<a id="#C317"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">RecoveryActTas<a id="#C318"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">ReceivesContracts<a id="#C319"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">ReceivesContractsAndGrants<a id="#C320"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">ReceivesGrants<a id="#C321"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">RecoveredMaterialClauses<a id="#C322"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">SmallBusinessResearch<a id="#C323"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">SubcontinentAsianOwned<a id="#C324"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">SelfCertifiedSmallDisadvantagedBusiness<a id="#C325"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">SeaTranportation<a id="#C326"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">ServiceContractAct<a id="#C327"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">ShelteredWorkshop<a id="#C328"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">SmallBusCompetativenessDemonstration<a id
="#C329"> </a></th>
								</tr>
							</thead>
							<tbody>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">SolicitationIdentifier<a id="#C330"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">SolicitationProcedures<a id="#C331"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">ServiceDisabledVeteranOwned<a id="#C332"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">StateGovernment<a id="#C333"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">StatutoryExemptionTypeFairOpportunity<a id="#C334"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">SubcontractingPlan<a id="#C335"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">SystemEquipmentCode<a id="#C336"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">TribalGovernment<a id="#C337"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">TypeOfIdc<a id="#C338"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">TypeOfSetAside<a id="#C339"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">EpaDesignatedProduct<a id="#C340"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">VendorAlternativeName<a id="#C341"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">VenderAlternativeCode<a id="#C342"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">VendorDoingBusinessAsName<a id="#C343"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">VendorLegalOrgName<a id="#C344"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">VeteranOwned<a id="#C345"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">WalshHealey<a id="#C346"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">WomanOwned<a id="#C347"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">AccountTitle<a id="#C348"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">AccountTitle<a id="#C349"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">DunsConfidenceCode<a id="#C350"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">Uri<a id="#C351"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">SaiNumber<a id="#C352"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">PrimeAwardAgencyId<a id="#C353"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">PrimeAwardDateSubmitted<a id="#C354"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">PrimeAwardPrincipalPlaceStreetAddress<a id="#C355"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">PrimeAwardReportId<a id="#C356"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">AwardReportMonth<a id="#C357"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">PrimeAwardReportType<a id="#C358"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">AwardReportYear<a id="#C359"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">ArraModelQuestion1<a id="#C360"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">ArraModelQuestion2<a id="#C361"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">SubawardNumber<a id="#C362"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">SubawardeeBusinessType<a id="#C363"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">TransactionNumber<a id="#C364"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">WebSiteUrl<a id="#C365"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">WhoCanUse<a id="#C366"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">MaximumOrderLimit<a id="#C367"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">FeeForUseOfService<a id="#C368"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">FixedFeeValue<a id="#C369"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">FeeRangeLowerValue<a id="#C370"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">FeeRangeUpperValue<a id="#C371"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">OrderingProcedure<a id="#C372"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
					...
					<div class="panel panel-body">
						<table class="table table-striped" style="width: 100%">
							<thead>
								<tr>
									<th style="width: 20%">DATA Act Field Name</th>
									<th style="width: 80%">FeePaidForUseOfIdv<a id="#C373"> </a></th>
								</tr>
							</thead>
							<tbody>
								<tr>
