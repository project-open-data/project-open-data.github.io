...
# The Latest
_December 22, 2017_: Treasury released the DATA Act Information Model Schema (DAIMS) v1.2. DAIMS v1.2 is a minor update of the schema and will be implemented with the submission of fiscal year 2018 quarter 3 data. Find out more at the [DAIMS v1.2]({{site.baseurl}}/DAIMS-v1.2/).
...
The [Data Dictionary]({{ site.baseurl }}/dictionary-v1.1/){:target="_blank"} is a comprehensive list of data elements with definitions and some associated metadata.
...
[Zipped Instance Documents with Data for Fiscal Year 2018 Quarter 1 (October to December 2018)](https://s3-us-gov-west-1.amazonaws.com/da-public-files/xbrl_files/data-act-xbrl-instance-Q1-2018-04-16.zip)
